...
$sql="SELECT * FROM router WHERE id_router='$id_router'";
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-4 col-md-offset-4">
          <div class="panel">
            <div class="panel-logo">
              <a href="../../index.php"><b>ROUTER</b> | FIT</a>
            </div>
            <div class="panel-item">
              <div class="img-alamat">
               <img src="http://image.shutterstock.com/z/stock-vector-gps-map-icon-129222473.jpg">
              </div>
              <form class="panel-cred" action="edit_router_simpan.php" method="POST">
                <div class="input-group">
                  <input type="text" class="form-control" name="lokasi" id="addresspicker_map" placeholder="Search address" value=<?php echo $data['lokasi']; ?> >
      ...
      <div class="row">
        ...
        <div class="address-item">            
              ...
              <input type="text" class=" form-input" name="lat" id="lat" placeholder="Lat" readonly="" value="<?php echo $data['lat']; ?> ">
              <input type="text" class=" form-input" name="lng" id="lng" placeholder="Lng" readonly="" value="<?php echo $data['lng']; ?> ">
              <input type="text" class="ipaddress" name="ip" placeholder="Ip address" required="" value="<?php echo $data['ip']; ?> ">
                <select name="cabang" required="">
                    <option value="" disabled selected>Cabang Dari</option>
                      <?php                                    
                        include "../koneksi.php";
                        $sql="SELECT * FROM router ORDER BY lokasi ASC";
                        $qry=mysqli_query($konek,$sql); while ($datas=mysqli_fetch_array($qry)) {
                        $lokasi     =$datas['lokasi'];
                        $lng     =$datas['lng'];
                        $lat     =$datas['lat'];
                      ?>
              ...
              <textarea placeholder="Keterangan Router" name="keterangan" required="" ><?php echo $data['keterangan']; ?></textarea>
              <input type="text" name="id_router" hidden  value=<?php echo $data['id_router']; ?>>
